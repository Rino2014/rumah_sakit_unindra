...
public class FormDokter extends javax.swing.JFrame {
    ...
    private void autoID() {
    try {
        // Mengurutkan dari ID terbesar untuk mengambil data terakhir
        String sql = "SELECT id_dokter FROM dokter ORDER BY id_dokter DESC LIMIT 1";
        st = con.createStatement();
        rs = st.executeQuery(sql);

        if (rs.next()) {
            // 1. Ambil String ID terakhir, misal "DR001"
            String idTerakhir = rs.getString("id_dokter"); 
            
            // 2. Potong teks "DR" (indeks ke-2 hingga akhir), mengambil angka "001"
            String nomorSaja = idTerakhir.substring(2); 
            
            // 3. Ubah string angka menjadi integer lalu tambah 1 (001 + 1 = 2)
            int angkaBaru = Integer.parseInt(nomorSaja) + 1; 
            
            // 4. Format kembali menjadi "DR" diikuti 3 digit angka (misal: "DR002")
            // %03d artinya angka akan ditulis minimal 3 digit, jika kurang akan ditambah nol di depan
            String idOtomatis = "DR" + String.format("%03d", angkaBaru);
            
            tid.setText(idOtomatis);
        } else {
            // Jika tabel dokter masih kosong/habis di-reset, mulai dari DR001
            tid.setText("DR001");
        }
    } catch (Exception e) {
        // Disarankan mencetak error di console agar mudah dilacak saat didebug di NetBeans
        e.printStackTrace(); 
        tid.setText("DR001");
    }
}
    ...
    private void tampilCheckbox(String hari){

        chkSenin.setSelected(
        hari.contains("Senin"));

        chkSelasa.setSelected(
        hari.contains("Selasa"));
    ...
    private void initComponents() {
        ...
        tjamkeluar = new javax.swing.JTextField();
        ...
        cpoli.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Poli Jantung", "Poli Anak", "Poli Kandungan dan Kebidanan", "Poli Gigi", "Poli Mata" }));

        jLabel11.setText("Spesialis");

        jLabel13.setText("Poli");

        cspesialis.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Spesialis Jantung", "Spesialis Anak", "Spesialis Kandungan", "Spesialis Gigi", "Spesialis Mata" }));
        ...
        tjamkeluar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tjamkeluarActionPerformed(evt);
            }
        });
        ...
        jLabel25.setText("Hari Praktik");

        jLabel16.setText("Tarif Konsultasi Dokter ");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(cspesialis, javax.swing.GroupLayout.PREFERRED_SIZE, 216, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(talamat, javax.swing.GroupLayout.PREFERRED_SIZE, 216, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(ttarif, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGap(18, 18, 18)
                                    .addComponent(tjammasuk, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(layout.createSequentialGroup()
                                    .addComponent(jLabel12)
                                    .addGap(18, 18, 18)
                                    .addComponent(tjamkeluar, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                .addGap(50, 50, 50))
        );
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel12)
                            .addComponent(tjamkeluar, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void tjamkeluarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tjamkeluarActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tjamkeluarActionPerformed
    ...
    private javax.swing.JTextField tjamkeluar;
